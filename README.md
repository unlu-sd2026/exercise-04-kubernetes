# Exercise 04 — Kubernetes Deployment
...
|------|-------|-------------------|
| **U4.4 Kubernetes orchestration** | Pods, Services, Deployments | Write K8s manifests to deploy the Node Registry to a Kubernetes cluster. |
...
Write K8s manifests to deploy the Node Registry to a Kubernetes cluster.
